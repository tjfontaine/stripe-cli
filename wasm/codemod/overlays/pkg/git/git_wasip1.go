...
func init() {
	// Register the WASM HTTP bridge transport for go-git.
	// This routes all git HTTP operations through the browser's fetch() API.
	httpClient := &http.Client{Transport: &wasmbridge.Transport{}}
